    ...
    ru: [
        ...
        },
        {
            ...
            submenu: [
                ...
                { label: "Рады вашему питомцу", href: "/services/pets/" },
                { label: "Фотосессия в интерьерах", href: "/photo-shoot/" },
            ],
        },
        { label: "Программа привилегий", href: "/rewards/" },
    ...
    en: [
        ...
        },
        {
            ...
            submenu: [
                ...
                { label: "Accomodation with pets", href: "/services/pets/" },
                { label: "Photoshoot in interiors", href: "/photo-shoot/" },
            ],
        },
        { label: "Rewards program", href: "/rewards/" },
...
/**
 * Страницы с полноэкранным hero: хедер закреплен поверх первого экрана
 * и до прокрутки остается прозрачным.
 */
