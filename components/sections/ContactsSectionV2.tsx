...
export default function ContactsSectionV2() {
        ...
        >
            ...
            <div className="flex flex-col gap-2 mx-6 my-4 xl:mx-0 xl:my-8 xl:min-w-84">
                ...
                <a
                    ...
                    className="mt-2 inline-flex items-center justify-center rounded-md bg-[#5c1f26] px-6 py-4 text-sm uppercase tracking-widest text-white transition-colors duration-300 hover:bg-[#46161c] xl:mt-4"
                >
                    {bookLabel}
                </a>
            </div>
