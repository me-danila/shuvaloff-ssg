...
export default function HomeServicesSection({ locale }: { locale: Locale }) {
    ...
    return (
        <section className="py-4">
            <div className="flex flex-col gap-4 mx-6 xl:w-full xl:max-w-7xl xl:mx-auto xl:gap-6">
                <div
                    ref={trackRef}
                ...
                <div className="mt-4 flex items-center justify-center gap-6 xl:mt-6">
                    <button
                        ...
                        aria-label="Previous"
                        onClick={() => go(-1)}
                        className="flex h-12 w-12 cursor-pointer items-center justify-center rounded-full bg-stone-100 text-stone-600 transition-colors duration-300 hover:bg-stone-200 active:bg-[#5c1f26] active:text-white"
                    >
