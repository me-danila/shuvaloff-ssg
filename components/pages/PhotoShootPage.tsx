...
const copyByLocale: Record<Locale, PhotoShootCopy> = {
    ru: {
        heroTitle: "Фотосъёмка в исторических интерьерах особняка Шувалова",
        heroDescription:
            "Изысканный исторический антураж для ваших эффектных кадров в атмосфере графского особняка XIX века",
        heroAlt: "Фотосъёмка в исторических интерьерах особняка Шувалова",
...
> = {
    ru: {
        name: "Фотосъёмка в особняке Шувалова",
        description:
            "Фотосъёмка в исторических интерьерах особняка Шувалова XIX века в центре Санкт-Петербурга.",
        homeCrumb: "Главная",
    },
    en: {
            ...
            <section>
                <div className="relative overflow-hidden aspect-8/15 xl:aspect-[unset] xl:min-h-screen">
                    ...
                    <StaggerContainer className="flex gap-2 h-65 xl:h-180 xl:gap-4 xl:w-full">
                        <div className="absolute bottom-10 md:bottom-20 xl:bottom-32 inset-x-0 text-center text-white z-10 flex flex-col gap-3 px-10 xl:max-w-5xl xl:mx-auto xl:gap-6">
                            <StaggerItem className="relative flex-1 min-w-0 overflow-hidden rounded-lg xl:rounded-md xl:max-w-5xl xl:mx-auto">
