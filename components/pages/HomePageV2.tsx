...
const ContactsSection = dynamic(
    () => import("@/components/sections/ContactsSectionV2"),
    { ssr: true },
);
...
export default function HomePageV2({ locale }: { locale: Locale }) {
        ...
        >
            ...
            <section>
                <div className="relative overflow-hidden aspect-8/10 xl:aspect-[unset] xl:min-h-screen">
                    ...
                    <StaggerContainer className="absolute left-6 top-20 z-10 flex flex-col items-start gap-3 xl:left-12 xl:top-40">
                        {heroButtons.map((b) => (
                    ...
                    <div className="absolute bottom-10 md:bottom-20 xl:bottom-32 inset-x-0 text-center text-white z-10 flex flex-col gap-3 px-10 xl:max-w-6xl xl:mx-auto xl:gap-6">
                        <FadeIn duration={1}>
                            <h1 className="font-alistair text-4xl normal-case leading-tight xl:text-5xl xl:mb-4">
                                Отдых
            ...
            <section className="flex flex-col gap-3 w-full px-6 xl:max-w-6xl xl:mx-auto xl:px-0 xl:py-12 xl:text-center">
                <FadeUp>
