...
const copyByLocale: Record<Locale, RunCopy> = {
    ru: {
        ...
        description:
            "Город еще спит, а вы уже в движении. Тихие улицы, шелест листвы, отражения рассвета в витринах. Маршрут проходит там, где Петербург особенно красив в это время — без шума, без спешки, только ритм шагов и свежий воздух нового дня.",
...
const seo = {
    ru: {
        ...
        description:
            "Город еще спит, а вы уже в движении. Тихие улицы, шелест листвы, отражения рассвета в витринах. Маршрут проходит там, где Петербург особенно красив в это время",
        crumbs: ["Главная"],
    },
    en: {
