...
const copyByLocale: Record<Locale, PageCopy> = {
    ru: {
        ...
        galleryAlts: [
            "Граф украшает елку, графиня держит новогодний подарок",
            "Праздничная закуска в хрустальной вазе на сервированном столе",
            "Гости за новогодним столом у елки в особняке Шувалова",
                ...
                menus: [
                    {
                        ...
                        items: [
                            ...
                            "Террин из трех видов мяса с трюфелем и сальсой",
                            ...
                            "Мини-оладьи со сметаной и черной икрой",
                            "Вода Dausuz Still",
                        ],
                    },
                ],
