...
const copyByLocale: Record<Locale, RewardsCopy> = {
    ru: {
        ...
        registerParagraph:
            "а с первой ночи начинается ваш путь к высококлассному уровню гостеприимства: чем больше путешествуете с ACADEMIA, тем больше внимания и приятных открытий ждет вас в каждом отеле нашей сети.",
