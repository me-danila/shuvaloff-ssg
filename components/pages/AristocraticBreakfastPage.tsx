...
const copyByLocale: Record<Locale, BreakfastCopy> = {
    ru: {
        ...
        description2: (
            <>
                Новая глава, вдохновленная аристократическими традициями, когда
        ...
        breakfastDescription1: (
            <>
                ...
                <br />• Каша пшенная съ масломъ сливочнымъ
                <br />• Вареніе вишневое
                <br />• Блины печеныя
                <br />• Бриошь
                <br />• Масло сливочное
                <br />• Лосось слабосоленый
                <br />• Рийетъ изъ тунца
                <br />• Оливы, каперсы и томаты
                <br />• Йогуртъ греческій съ ягодами
                <br />• Кремъ шоколадный съ ягодами
                <br />• Сокъ апельсиновый
                <br />• Чай черный съ лимономъ и королевскимъ финикомъ
                <br />• Бокалъ Кремана
            </>
        ),
        ...
        breakfastDescription2: (
            <>
                ...
                <br />
                • Похлебка съ дичью и бѣлыми грибами
                <br />
        ...
        quoteTitle2:
            "Теперь и вы можете стать частью этой традиции — позволить себе утро без спешки, где все дышит красотой, свободой и настоящим вкусом жизни.",
        quoteDescription2:
            "Это гастрономическое путешествие сквозь время, в котором каждая деталь — от посуды до атмосферы — символ утонченности, роскоши и памяти о великом.",
