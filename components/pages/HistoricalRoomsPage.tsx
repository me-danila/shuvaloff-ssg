...
type HistoricalCopy = {
    title: string;
    intro: { id: string; body: React.ReactNode }[];
...
const copyByLocale: Record<Locale, HistoricalCopy> = {
    ru: {
        ...
        intro: [
            {
                id: "heritage",
                body: "Исторические люксы — объекты культурного наследия, в которых сохранены детали отделки, восстановлен изначальный цвет стен и добавлены подлинные антикварные предметы эпохи конца XIX — начала ХХ века.",
            },
            {
                id: "residences",
                body: "Это резиденции, отражающие характер владельцев особняка: графа Андрея Шувалова и его дочери Елизаветы Воронцовой-Дашковой. Изысканные линии, глубокие цвета и изящные детали дают возможность почувствовать себя дорогим гостем одного из известных аристократических домов Российской Империи. Стены особняка хранят память о людях, которые здесь жили — не выдуманных персонажах, а реальных аристократах. Помнят их уклад жизни, вечерние разговоры при свечах, неспешные шаги по мраморной лестнице, звуки рояля, шелест парадного платья, мягкий свет люстры — все это не декорации.",
            },
            {
                id: "continuity",
                body: "Это отблески жизни, которой когда-то был наполнен особняк.",
            },
        ],
        ...
        descriptions: {
            dashkova:
                "Изящный люкс, названный в честь Елизаветы Андреевны Воронцовой-Дашковой (урожденной Шуваловой, 1845-1924), с ярким, но утонченным интерьером, отражает многогранную личность хозяйки особняка.",
            shuvalov:
