...
export default function Policy() {
    return (
        <main className="flex flex-col gap-8">
            <section className="flex flex-col gap-4 xl:gap-8 px-6 my-6 w-full xl:max-w-6xl xl:mx-auto">
                ...
                <p>
                    ...
                    адрес для корреспонденции: г&nbsp;Санкт-Петербург,
                    ул.&nbsp;Моховая д.&nbsp;10 стр.&nbsp;1 пом. 15-н, 16-н,
                    электронная почта для направления обращений по&nbsp;вопросам
                    ...
                    (включая посетителей веб-сайта, гостей Отеля и&nbsp;проч.)
                    <br />
                    ...
                    предоставления таким лицам возможности дальнейшей обработки
                    раскрытых персональных данных.
                    <br />
                    2.11. Сбор&nbsp;— принятие персональных данных
                    непосредственно от&nbsp;субъекта персональных данных или его
                    представителя.
                    <br />
                    2.12. Запись&nbsp;— ввод персональных данных в&nbsp;ЭВМ или
                    фиксация персональных данных на&nbsp;материальном носителе.
                    <br />
                    2.13. Систематизация&nbsp;— расположение персональных данных
                    в&nbsp;определенной последовательности.
                    <br />
                    2.14. Накопление&nbsp;— формирование исходного,
                    несистематизированного массива персональных данных.
                    <br />
                    2.15. Хранение&nbsp;— процесс передачи персональных данных
                    во&nbsp;времени, связанный с&nbsp;обеспечением неизменности
                    состояний материального носителя персональных данных.
                    <br />
                    2.16. Уточнение&nbsp;— обновление или изменение персональных
                    данных.
                    <br />
                    2.17 Обновление&nbsp;— приведение записанных персональных
                    данных в&nbsp;соответствие с&nbsp;состоянием отображаемых
                    ...
                    или иных лиц, либо другим образом затрагивающих права
                    и&nbsp;свободы субъекта персональных данных или иных лиц.
                    <br />
                    2.20. Уничтожение персональных данных&nbsp;— любые действия,
                    ...
                    их&nbsp;восстановления
                    <br />
                    2.22. Трансграничная передача&nbsp;— передача персональных
                    данных на&nbsp;территорию иностранного государства органу
                    власти иностранного государства, иностранному физическому
                    лицу или иностранному юридическому лицу.
                    <br />
                    2.23. Отель&nbsp;— Бутик-отель «ACADEMIA Особняк SHUVALOFF»
                    ...
                    <br />
                    <br />
                    5. Категории и&nbsp;перечень персональных данных, которые
                    ...
                    браузера, информация об&nbsp;аппаратном и&nbsp;программном
                    обеспечении, дата и&nbsp;время осуществления доступа
                    к&nbsp;сайту, далее совместно&nbsp;— «куки-файлы»)
                    с&nbsp;помощью сервисов интернет-статистики (Яндекс
                    Метрика);
                    <br />
