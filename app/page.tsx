        ...
        <main className="flex flex-col gap-6">
            ...
            <section className="flex flex-col gap-2 mx-6 relative xl:text-center xl:mx-0">
                ...
                <FadeUp delay={0.1}>
                    <p className="my-2 xl:max-w-4xl xl:mx-auto">
                        ...
                        чтобы вы&nbsp;могли погрузиться в&nbsp;неспешный ритм
                        жизни аристократического Петербурга.
                    </p>
                </FadeUp>
            ...
            <section className="flex flex-col mx-6 gap-3 xl:max-w-6xl xl:mx-auto xl:flex-row xl:gap-8 xl:text-justify">
                <FadeUp className="xl:flex-1">
                    <p>
                        Историческая лепнина, мрамор, парадная лестница,
                        кессонный потолок в&nbsp;ресторане и&nbsp;антикварные
                        предметы в&nbsp;исторических резиденциях&nbsp;— всё для
                        того, чтобы вы&nbsp;могли почувствовать шепот истории
                        в&nbsp;этих стенах, не&nbsp;отказывая себе
                ...
                <FadeUp delay={0.3} className="xl:flex-1">
                    <p>
                        ...
                        Вы&nbsp;сможете стать частью новой жизни старинного
                        особняка и&nbsp;вписать свою страницу в&nbsp;его
                        историю.
                    </p>
                </FadeUp>
            ...
            <section className="flex flex-col gap-3 xl:text-center xl:mt-4">
                ...
                <FadeUp delay={0.1}>
                    <p className="mx-6 xl:max-w-4xl xl:mx-auto xl:mt-2">
                        ...
                        из&nbsp;самых красивых мест исторического
                        Петербурга&nbsp;— на&nbsp;тихой Моховой улице, рядом
                        с&nbsp;набережными Невы и&nbsp;Фонтанки, Летним
                        и&nbsp;Михайловским садами, Михайловским замком
                        и&nbsp;Марсовым полем. &nbsp;Дворец бракосочетания
                        №&nbsp;2 находится в&nbsp;пешей доступности
                        на&nbsp;улице Фурштатской.
                    </p>
                </FadeUp>
                <FadeUp delay={0.2}>
                    <p className="mx-6 xl:max-w-4xl xl:mx-auto xl:mt-2">
                        До&nbsp;Невского проспекта вы&nbsp;дойдете
                        за&nbsp;двадцать минут неспешным шагом,
                        и&nbsp;за&nbsp;это время вы&nbsp;прогуляетесь
                        по&nbsp;историческим мостам через Фонтанку, Мойку,
                        Лебяжью канавку и&nbsp;канал Грибоедова или пройдетесь
                        по&nbsp;набережной Невы with открыточными видами
                        на&nbsp;Петропавловскую крепость, Троицкий
                ...
                <FadeUp delay={0.3}>
                    <p className="mx-6 text-center font-alistair text-2xl text-stone-400 xl:text-[40px] xl:max-w-3xl xl:mx-auto xl:mt-4 xl:-mb-2">
                        Идеальное расположение для тех, кто&nbsp;ценит
            ...
            <section className="flex flex-col gap-3 mx-6 xl:max-w-6xl xl:mx-auto xl:text-center">
                ...
                <FadeUp delay={0.1}>
                    <p className="xl:max-w-3xl xl:mx-auto">
                        Мы превращаем пребывание гостей в нашем особняке в
                        необычное погружение, в котором пространство, люди и
                        детали становятся частью единого художественного и
                        исторического замысла.&nbsp;Мы воссоздаем жизнь эпохи с
                        помощью театрализованных форматов, сценических зарисовок
                        и живых персонажей, которые могут встречать и
                ...
                <FadeUp delay={0.3}>
                    <p className="xl:max-w-3xl xl:mx-auto">
                        Граф Шувалов и его семья возвращаются в свою резиденцию
                        с пятницы по воскресенье, чтобы наполнить ее подлинной
                        жизнью и атмосферой своей эпохи. Их общение with гостями
                        столь же естественно и непредсказуемо, как и в XIX веке:
                        мимолетная встреча в холле особняка, изящный комплимент
                        во время прогулки по залам или случайная беседа у бара.
                    </p>
                </FadeUp>
                <FadeUp delay={0.4}>
                ...
                <div className="flex flex-col gap-4 xl:my-4 xl:flex-1">
                    ...
                    <FadeUp delay={0.2}>
                        <p>
                            ...
                            ресторана ACADEMIA BAR SHUVALOFF, расслабиться
