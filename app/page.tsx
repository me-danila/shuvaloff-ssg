            ...
            <section className="flex flex-col gap-3 xl:text-center xl:mt-4">
                ...
                <FadeUp delay={0.2}>
                    <p className="mx-6 xl:max-w-4xl xl:mx-auto xl:mt-2">
                        ...
                        по&nbsp;набережной Невы с&nbsp;открыточными видами
            ...
            <section className="flex flex-col gap-3 mx-6 xl:max-w-6xl xl:mx-auto xl:text-center">
                ...
                <FadeUp delay={0.3}>
                    <p className="xl:max-w-3xl xl:mx-auto">
                        ...
                        жизнью и атмосферой своей эпохи. Их общение
                        с&nbsp;гостями столь же естественно и непредсказуемо,
                        как и в XIX веке: мимолетная встреча в холле особняка,
                        изящный комплимент во время прогулки по залам или
                        случайная беседа у бара.
                    </p>
                </FadeUp>
                <FadeUp delay={0.4}>
