...
export default function TransferPage() {
    return (
        <main className="flex flex-col gap-8 xl:gap-8">
            ...
            <section className="mx-6 flex flex-col gap-4 xl:max-w-6xl xl:mx-auto xl:w-full xl:grid xl:grid-cols-[1fr_1.2fr] xl:items-stretch xl:gap-6">
                <div className="flex flex-col gap-4">
                    {transferCards.map(({ Icon, label, price, note }) => (
                        <div
                            key={label}
                            className="bg-brand-blue-100 rounded-md p-4 flex flex-col items-center text-center gap-3 xl:p-5"
                        >
                            <Icon
                                size={32}
                ...
                <div className="relative w-full h-72 md:h-90 xl:h-full overflow-hidden rounded-md">
                    <Image
            ...
            <div className="mx-6 flex justify-center xl:max-w-6xl xl:mx-auto xl:w-full">
                <Button
                    href="https://t.me/+79668342743"
                    target="_blank"
                    variant="primary"
