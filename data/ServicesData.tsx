    ...
    ru: [
        {
            ...
            fullDescription: (
                <>
                    ...
                    скрембл с&nbsp;трюфелем и&nbsp;креветками&nbsp;&mdash; все
        ...
        },
        {
            title: "ACADEMIA СПА",
            subtitle:
                "Мы создали ACADEMIA СПА для тех, кто ценит высокие стандарты сервиса, заботу о себе и о своем внутреннем комфорте",
        ...
        //        },
        {
            ...
            fullDescription: (
                <>
                    Мы&nbsp;с&nbsp;радостью подберем идеальный букет
        ...
        },
        {
            ...
            fullDescription: (
                <>
                    ...
                    предупредить заранее: в&nbsp;ресторане действует легкий
        ...
        },
        {
            ...
            subtitle:
                "Изысканная услуга для особого события — вдохновленная эпохой, когда дом Ruinart впервые заворожил аристократию.",
        ...
        },
        {
            title: "День рождения",
            subtitle:
                "Особый формат поздравления в ACADEMIA, чтобы день рождения стал не просто поводом, а событием — красивым, теплым, запоминающимся.",
            imgUrl: "https://academia.spb.ru/wp-content/uploads/2025/02/bar4-1-1.avif",
            slug: "birthday",
            fullDescription: (
                <>
                    &bull; Воздушные шары в&nbsp;изысканных
                    оттенках&nbsp;&mdash; для легкого и&nbsp;радостного
                    настроения
                    <br />
                    &bull; Декоративная надпись HAPPY BIRTHDAY&nbsp;&mdash;
                    тонкий акцент на&nbsp;детали
                    <br />
                    &bull; Бутылка охлажденного игристого вина&nbsp;&mdash; для
        ...
        },
        {
            ...
            fullDescription: (
                <>
                    ...
                    варианты доступны, и&nbsp;поможет подобрать ту, что подойдет
                    именно вам.
                    <br />
                    Если у&nbsp;вас будут вопросы или потребуется помощь
        ...
        },
        {
            ...
            subtitle:
                "Мы с радостью берем на себя заботу о вашем багаже в день заезда и выезда.",
        ...
        },
        {
            ...
            fullDescription: (
                <>
                    ...
                    на&nbsp;набережной Фонтанки. Вас ждет прогулка
                    ...
                    с&nbsp;десертом, вдохновленным творчеством Карла Фаберже.
        ...
        },
        {
            ...
            fullDescription: (
                <>
                    ...
                    фруктовая тарелка, составленная с&nbsp;учетом сезонности,
                    или коллекция антипасти с&nbsp;легкими гастрономическими
        ...
        },
        {
            ...
            fullDescription: (
                <>
                    ...
                    <br />
                    &bull; Бутылка охлажденного игристого вина
                    <br />
        ...
        {
            title: "Ранний заезд",
            subtitle: "Планируйте свое время так, как удобно именно вам.",
